...
mude o estado para, ligado. Após esse processo o sistema irá contabilzar a média da corrente que passou pelo dispositivo, e ao ser desligado o resultado
das médias irá ser transmitido via \textit{websocket} para o servidor \textit{web} e se juntará com o resultado do tempo em que o dispositivo permaneceu
ligado para que por fim se possa ter o consumo e o gasto deferido pelo equipamento. 
