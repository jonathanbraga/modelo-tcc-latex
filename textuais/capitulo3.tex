...
que será facilitada por meio da biblioteca \textit{SocketIOClient}, ela nos proporciona alguns métodos como: \textit{\textbf{emit}}\protect\footnotemark, \textit{\textbf{on}}\protect\footnotemark 
