...
\titulo{{\normalfont \textbf{POWER MONITOR - PROPOSTA DE UMA FERRAMENTA DE BAIXO CUSTO PARA O MONITORAMENTO DE ENERGIA RESIDENCIAL}}}
...
\preambulo{Trabalho de Conclusão de Curso apresentado ao curso de Engenharia Mecatrônica da Universidade Federal do Rio Grande do Norte como parte dos requisitos para a obtenção do título de Engenheiro Mecatrônico, orientado pelo Professor Carlos Manuel Dias Viegas.}
...
\begin{titlingpage}
	\begin{center}
		...
		\vspace*{\fill}
		\textbf{POWER MONITOR - PROPOSTA DE UMA FERRAMENTA DE BAIXO CUSTO PARA O MONITORAMENTO DE ENERGIA RESIDENCIAL}
		\vspace*{\fill}
